...
export default function WhatsAppFloat() {
  return (
    <div className="whatsapp-float">
      <motion.a
        href="https://wa.me/15551234567?text=Hi!%20I'd%20like%20to%20book%20an%20appointment."
        target="_blank"
        rel="noopener noreferrer"
        className="relative flex items-center justify-center w-14 h-14 rounded-full shadow-lg overflow-visible"
      ...
      <motion.div
        ...
        className="absolute right-16 bottom-2 bg-gray-900 text-white text-xs font-medium px-3 py-1.5 rounded-full whitespace-nowrap shadow-lg"
      >
        Chat with us 💬
